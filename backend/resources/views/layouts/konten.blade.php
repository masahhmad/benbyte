...
<body>
    ...
    <div id="app">
        @if (Route::currentRouteName() !== 'admin.view-kreator' && Route::currentRouteName() !== 'kreator.konten-kelas' && Route::currentRouteName() !== 'admin.detail-kelas-kreator' && Route::currentRouteName() !== 'user.beli-kelas' && Route::currentRouteName() !== 'user.lanjut-beli')
        <div id="sidebar">
        ...
        @endif
    <div id="{{Route::currentRouteName() === 'admin.view-kreator' || Route::currentRouteName() === 'kreator.konten-kelas' || Route::currentRouteName() === 'admin.detail-kelas-kreator' || Route::currentRouteName() === 'user.beli-kelas' || Route::currentRouteName() === 'user.lanjut-beli' ? '' : 'main'}}" class='layout-navbar navbar-fixed'>

        @if (Route::currentRouteName() === 'admin.view-kreator' || Route::currentRouteName() === 'kreator.konten-kelas' || Route::currentRouteName() === 'kreator.edit-konten-kelas' || Route::currentRouteName() === 'admin.detail-kelas-kreator' || Route::currentRouteName() === 'user.beli-kelas' || Route::currentRouteName() === 'user.lanjut-beli')
